...
//  DID:       Name:                                       Example host CPUs:
    ...
    [0x0d22] = "Iris Pro Graphics 5200",                // Core i5-4570R
    [0x0d26] = "Iris Pro Graphics 5200",                // Core i7-4750HQ
    ...
    [0x87ca] = "UHD Graphics 617",                      // Core i5-10310Y
    [0x8a51] = "Iris Plus Graphics",                    // Core i5-1030G7
    [0x8a52] = "Iris Plus Graphics",                    // Core i5-1035G7
    [0x8a53] = "Iris Plus Graphics",                    // Core i5-1038NG7
    [0x8a56] = "UHD Graphics for 10th Gen (32EU)",      // Core i3-1005G1
    [0x8a58] = "UHD Graphics for 10th Gen (32EU)",      // Core i3-1000G1
    [0x8a5a] = "Iris Plus Graphics",                    // Core i5-1035G4
    [0x8a5c] = "Iris Plus Graphics",                    // Core i5-1030G4
    //[9840] = "Lakefield GT2 [UHD Graphics]",          // 
    //[9841] = "Lakefield GT1.5 [UHD Graphics]",        // 
    [0x9a40] = "Iris Xe Graphics",                      // Core i5-1140G7
    [0x9a49] = "Iris Xe Graphics (80EU)",               // Core i5-1135G7
    [0x9a60] = "UHD Graphics for 11th Gen (32EU)",      // Core i9-11950H
    [0x9a68] = "UHD Graphics for 10th/11th Gen (16EU)", // Core i5-11260H, Celeron 6600HE, Xeon W-11155MLE
    [0x9a70] = "UHD Graphics for 11th Gen (32EU)",      // Xeon W-11555MLE
